...
- [👀 Esempi](#-examples)
  - [`[]` è uguale a `![]`](#-is-equal-)
  - [`true` è diverso da `![]`, ma anche diverso da `[]` ](#true-is-not-equal--but-not-equal--too)
  - [true è false](#true-is-false)
  - [baNaNa](#banana)
  - [`NaN` non è `NaN`](#nan-is-not-a-nan)
  - [È un fail](#its-a-fail)
  - [`[]` è truthy, ma non `true`](#-is-truthy-but-not-true)
  - [`null` è falsy, ma non `false`](#null-is-falsy-but-not-false)
  - [`document.all` è un object, ma è undefined](#documentall-is-an-object-but-it-is-undefined)
  - [Il numero più piccolo rappresentabile è maggiore di zero](#minimal-value-is-greater-than-zero)
  - [function non è una function](#function-is-not-a-function)
  - [Sommare array](#adding-arrays)
  - ["Trailing commas" in un array](#trailing-commas-in-array)
  - [L'operatore di uguaglianza sugli array è un mostro](#array-equality-is-a-monster)
  - [`undefined` e `Number`](#undefined-and-number)
  - [`parseInt` è bast**do](#parseint-is-a-bad-guy)
  - [Math con `true` e `false`](#math-with-true-and-false)
  - [I commenti HTML sono validi anche in JavaScript](#html-comments-are-valid-in-javascript)
  - [`NaN` è ~~not~~ a number](#nan-is-not-a-number)
  - [`[]` e `null` sono objects](#-and-null-are-objects)
  - [Incrementare numeri magicamente](#magically-increasing-numbers)
  - [La precisione di `0.1 + 0.2`](#precision-of-01--02)
  - [Patchare numeri](#patching-numbers)
  - [Confrontare tre numeri](#comparison-of-three-numbers)
  - [Matematica spassosa](#funny-math)
  - [Somma di RegExps](#addition-of-regexps)
  - [Le stringhe non sono istanze di `String`](#strings-arent-instances-of-string)
  - [Richiamare funzioni con le backticks](#calling-functions-with-backticks)
  - [Call call call](#call-call-call)
  - [Una proprietà chiamata `constructor`](#a-constructor-property)
  - [Un Object usato come key nelle property di un oggetto](#object-as-a-key-of-objects-property)
  - [Accedere ai prototypes con `__proto__`](#accessing-prototypes-with-__proto__)
  - [`` `${{Object}}` ``](#-object-)
  - [Destructuring con valori di default](#destructuring-with-default-values)
  - [Puntini e lo spreading](#dots-and-spreading)
  - [Labels](#labels)
  - [Labels annidate](#nested-labels)
  - [Un `try..catch` insidioso](#insidious-trycatch)
  - [Questa è ereditarietà multipla?](#is-this-multiple-inheritance)
  - [Un generator che produce se stesso](#a-generator-which-yields-itself)
  - [Una classe di tipo class](#a-class-of-class)
  - [Oggetti non-coercible](#non-coercible-objects)
  - [Arrow functions strambe](#tricky-arrow-functions)
  - [Arrow functions non possono essere un costruttore](#arrow-functions-can-not-be-a-constructor)
  - [`arguments` e arrow functions](#arguments-and-arrow-functions)
  - [Uno strano return](#tricky-return)
  - [Concatenare assegnamenti su un object](#chaining-assignments-on-object)
  - [Accedere alle properties di un object con gli array](#accessing-object-properties-with-arrays)
  - [Null e gli operatori relazionali ](#null-and-relational-operators)
  - [`Number.toFixed()` mostra numeri diversi](#numbertofixed-display-different-numbers)
  - [`Math.max()` più piccolo di `Math.min()`](#mathmax-less-than-mathmin)
  - [Confrontare `null` con `0`](#comparing-null-to-0)
  - [Alcune ridichiarazioni di variabili](#same-variable-redeclaration)
  - [Comportamento di default di Array.prototype.sort()](#default-behavior-arrayprototypesort)
  - [resolve() non restituisce un'istanza di Promise](#resolve-wont-return-promise-instance)
