...
Note that this can easily happen if your function returns an object and you call it here instead of passing it 🤦🏽‍♀️🤦🏽‍♀️!

#### What if the content - policy is set to 'self'?
